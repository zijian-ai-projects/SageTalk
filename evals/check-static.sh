...
test -f README.zh-CN.md || fail "missing README.zh-CN.md"
test -f README.en.md || fail "missing README.en.md"
grep -q 'Language / 语言' README.md || fail "README missing language switch"
grep -q 'README.zh-CN.md' README.md || fail "README missing Chinese README link"
grep -q 'README.en.md' README.md || fail "README missing English README link"
grep -q '## 安装' README.zh-CN.md || fail "Chinese README missing installation section"
grep -q '## Installation' README.en.md || fail "English README missing installation section"
grep -q '## 使用' README.zh-CN.md || fail "Chinese README missing usage section"
grep -q '## Usage' README.en.md || fail "English README missing usage section"
grep -q '## 示例' README.zh-CN.md || fail "Chinese README missing examples section"
grep -q '## Examples' README.en.md || fail "English README missing examples section"
grep -q 'git clone git@github.com:zijian-ai-projects/SageTalk.git' README.zh-CN.md || fail "Chinese README missing clone command"
grep -q 'git clone git@github.com:zijian-ai-projects/SageTalk.git' README.en.md || fail "English README missing clone command"
grep -q '.agents/skills' README.zh-CN.md || fail "Chinese README missing canonical skill directory"
grep -q '.agents/skills' README.en.md || fail "English README missing canonical skill directory"
grep -q 'sage-talk' README.zh-CN.md || fail "Chinese README missing sage-talk entrypoint"
grep -q 'sage-talk' README.en.md || fail "English README missing sage-talk entrypoint"
grep -q '不只限于 Codex' README.zh-CN.md || fail "Chinese README missing non-Codex support boundary"
grep -q 'not limited to Codex' README.en.md || fail "English README missing non-Codex support boundary"
pass "README split documents bilingual install, usage, examples, and platform boundaries"
